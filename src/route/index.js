...
import TestContainer from '../container/home'; // 一个主页的container
import TestGeolocation from '../container/geolocation';
...
<Route path="/" component={RootContainer}> // 所有的访问，都跳转到rootContainer
    ...
    <Route path="/getLocation" component={TestGeolocation}/>
